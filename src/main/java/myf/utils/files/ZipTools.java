...
public class ZipTools {  
    ...
    public static void main(String[] args) throws Exception {
		//zipFile("./file/", "./file/zhangqi.zip");
        //生成压缩文件
        ZipTools.zipFile("C://aaa/20190716/","C://bbb/bdp_bleach.zip");
        //删除文件夹下的文件，包含本机目录 bleach
      //  deleteDirFile("C://aaa/bleach");
	}

    /**
     * 将目录压缩成文件
     * @param baseDir 压缩目录路径
